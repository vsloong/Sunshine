...
public class BookSearch {
    ...
    @Generated(hash = 1498985106)
    public BookSearch(Long id, String userId, String bookName, String author,
                      String editor, String publishing, String callNum, String collectionNum,
                      String borrowNum) {
        this.id = id;
        this.userId = userId;
